...
|------|--------|-------------|---------------|---------------|-------|
| G10 | FIX-001–005 | LEAD-009 #1–6 source closed locally | mypy; scoped idempotency; bootstrap split; release evidence; provider fail-closed; parser fixture-only; local CI green | **no** | Await tip CI + lead accept; CLI login still Not logged in |
