...
def main() -> None:
    ...
    if args.command == "serve":
        ...
        matrices = build_version_matrices(campaign=report)
        print(
            json.dumps(
                {
        ...
        campaign = run_acceptance_campaign(live_grant=None)
        print(json.dumps(build_version_matrices(campaign=campaign), indent=2, default=str))
