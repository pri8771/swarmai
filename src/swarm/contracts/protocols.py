...
@runtime_checkable
class DurableWorkerControlPlane(Protocol):
    """V2A-004 transport-independent durable worker control plane."""

    def enroll(self, request: Any) -> Any: ...
    def heartbeat(self, request: Any) -> Any: ...
    def claim(self, request: Any) -> Any: ...
    def renew(self, request: Any) -> Any: ...
    def submit_result(self, request: Any) -> Any: ...
    def drain(self, request: Any) -> Any: ...
    def cancel_lease(self, request: Any) -> Any: ...
    def reconnect(self, request: Any) -> Any: ...
    def accept_result(self, *, result_id: str) -> Any: ...
